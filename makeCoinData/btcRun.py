...
class MetaModelPredictor:
    ...
    def load_models(self):
        try:
            ...
            # 각 모델 파일 경로
            meta_path = f"{self.model_dir}/meta_model_0.0047.pkl"
    ...
    def prepare_data(self, data):
        ...
        print("Before scaling:", features_data[:5])  # 스케일링 전 데이터
        print("After scaling:", scaled_data[:5])    # 스케일링 후 데이터
    ...
    def predict(self, data):
        ...
        try:
            ...
            print("LSTM input shape:", lstm_data.shape)
            # 각 모델별 예측
...
def main():
    # 파일 경로 설정
    model_dir = r"F:\work space\coin\price_data\models\KRW-BTC_20250114_060448"
    data_file_path = r"F:\work space\coin\price_data\KRW-BTC_with_tech_indicators.csv"
